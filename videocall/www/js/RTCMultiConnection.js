...
window.RTCMultiConnection = function (roomid, forceOptions) {
    ...
    function getRMCMediaElement(stream, callback, connection) {
        ...
        // @cdiglesias
        if (window.rtcRefresh !== 'undefined' && typeof window.rtcRefresh === 'function')
            window.rtcRefresh(mediaElement);
    ...
    function setCordovaAPIs() {
        ...
        // @cdiglesias
        window.rtcRefresh = function (media) {
            iosrtc.observeVideo(media);
